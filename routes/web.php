...
Route::get('/sensores/estadisticas', [SensorController::class, 'estadisticas'])->name('sensores.estadisticas');

Route::get('/registros-comportamientos', [ComportamientoController::class, 'index'])->name('registros_comportamientos.index');
